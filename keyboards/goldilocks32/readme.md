...
You can [download pre-compiled Goldilocks32 firmware](https://github.com/peterjc/qmk_userspace/releases),
`goldilocks32_vial.uf2` with Vial support, which is recommended as you can the use
the [Vial GUI tool](https://get.vial.today/) to configure your layout by point-and-click.
This is the default keymap:

![Default keymap for the Goldilocks32 keyboard QMK firmware](../../keymap-drawer/goldilocks32.svg)
...
* Hardware Supported: Goldilocks32 (no-diode twin PCB) using Raspberry Pi Pico
* Hardware Availability: https://codeberg.org/peterjc/pico-keyboards/src/branch/main/goldilocks32
* Download Firmware pre-compiled with Vial support: [goldilocks32_vial.uf2](https://github.com/peterjc/qmk_userspace/releases/download/latest/goldilocks32_vial.uf2)

See also the [Goldilocks32 ZMK firmware](https://github.com/peterjc/zmk-keyboard-graph-theory/tree/main/boards/shields/goldilocks32).

## Compiling

Make example for this keyboard (after setting up your build environment):

    make goldilocks32:default

Flashing example for this keyboard:

    make goldilocks32:default:flash
