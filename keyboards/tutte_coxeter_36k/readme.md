...
![Default keymap for the Slump52 keyboard QMK firmware](../../keymap-drawer/tutte_coxeter_36k.svg)
...
* **Physical reset button**: Briefly press the button on the front of the controller (if physically accessible from the back of the keyboard)
